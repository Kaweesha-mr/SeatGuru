...
<body>
    ...
    <div class="summary-bar-seat" id="summary-bar-l">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="border-right: 1px solid #948e8e">
                    <div class="summary-route">
                        <span><span class="s-station">Kurunegala</span></span>
                        <span><i class="fas fa-chevron-right"></i></span>
                        <span><span class="e-station">Colombo Fort</span></span>
                        <span id="forword_summary" style="display: none">(Train Selected)</span>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12" style="border-right: 1px solid rgb(148, 142, 142); display: none;" id="return_summary_div">
                    <div class="summary-route">
                        <span><span class="e-station">Colombo Fort</span></span>
                        <span><i class="fas fa-chevron-right"></i></span>
                        <span><span class="s-station">Kurunegala</span></span>
                        <span id="return_summary" style="display: none">(Return Train Selected)</span>
                    </div>
                </div>
                <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 mx-auto">
                    
                    <button id="landingProceedBtn" type="button" onclick="validateTrainSelect()" class="btn btn-primary seat-btn">
                        Proceed
                    </button>
                </div>
            </div>
